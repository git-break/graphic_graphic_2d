...
const ProcessToken TEST_TOKEN{TEST_PID, TEST_TIMESTAMP};
const ProcessToken TEST_TOKEN_2{TEST_PID_2, TEST_TIMESTAMP_2};
const ProcessToken TEST_TOKEN_3{TEST_PID_3, TEST_TIMESTAMP};
} // namespace
...
void RSMultiRenderProcessManagerTest::TearDown()
{
    if (multiProcessManager_ != nullptr) {
        ...
        multiProcessManager_->groupIdToRenderProcessToken_.clear();
        ...
        multiProcessManager_->validRenderProcessTokens_.clear();
        multiProcessManager_->deathRecipients_.clear();
    }
}
...
{
    ASSERT_NE(multiProcessManager_, nullptr);
    multiProcessManager_->AddValidRenderProcessToken(TEST_TOKEN);
 ...
 * @tc.desc: Test UpdateGroupIdToRenderProcessToken and GetRenderProcessTokenByGroupId
 * @tc.type: FUNC
 * @tc.require:
 */
...
{
    ASSERT_NE(multiProcessManager_, nullptr);
    auto result = multiProcessManager_->GetRenderProcessTokenByGroupId(TEST_GROUP_ID);
    EXPECT_FALSE(result.has_value());
    multiProcessManager_->UpdateGroupIdToRenderProcessToken(TEST_GROUP_ID, TEST_TOKEN);
    result = multiProcessManager_->GetRenderProcessTokenByGroupId(TEST_GROUP_ID);
 ...
 * @tc.desc: Test UpdateGroupIdToRenderProcessToken overwrites existing
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSMultiRenderProcessManagerTest, UpdateAndGetGroupIdToPid002, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    multiProcessManager_->UpdateGroupIdToRenderProcessToken(TEST_GROUP_ID, TEST_TOKEN);
    multiProcessManager_->UpdateGroupIdToRenderProcessToken(TEST_GROUP_ID, TEST_TOKEN_2);
    auto result = multiProcessManager_->GetRenderProcessTokenByGroupId(TEST_GROUP_ID);
    ASSERT_TRUE(result.has_value());
...
/**
 * @tc.name: GetServiceToRenderConnByToken001
 * @tc.desc: Test GetServiceToRenderConnByToken returns nullptr when not found
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSMultiRenderProcessManagerTest, GetServiceToRenderConnByToken001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    auto conn = multiProcessManager_->GetServiceToRenderConnByToken(TEST_TOKEN);
    EXPECT_EQ(conn, nullptr);
}

/**
 * @tc.name: GetServiceToRenderConnByToken002
 * @tc.desc: Test GetServiceToRenderConnByToken returns connection when found
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSMultiRenderProcessManagerTest, GetServiceToRenderConnByToken002, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
...
/**
 * @tc.name: GetServiceToRenderConnByTokenLocked001
 * @tc.desc: Test GetServiceToRenderConnByTokenLocked returns nullptr when not found
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSMultiRenderProcessManagerTest, GetServiceToRenderConnByTokenLocked001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    auto conn = multiProcessManager_->GetServiceToRenderConnByTokenLocked(TEST_TOKEN);
    EXPECT_EQ(conn, nullptr);
}

/**
 * @tc.name: GetConnectToRenderConnByToken001
 * @tc.desc: Test GetConnectToRenderConnByToken returns nullptr when not found
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSMultiRenderProcessManagerTest, GetConnectToRenderConnByToken001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    auto conn = multiProcessManager_->GetConnectToRenderConnByToken(TEST_TOKEN);
    EXPECT_EQ(conn, nullptr);
}

/**
 * @tc.name: GetConnectToRenderConnByTokenLocked001
 * @tc.desc: Test GetConnectToRenderConnByTokenLocked returns nullptr when not found
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSMultiRenderProcessManagerTest, GetConnectToRenderConnByTokenLocked001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    auto conn = multiProcessManager_->GetConnectToRenderConnByTokenLocked(TEST_TOKEN);
    EXPECT_EQ(conn, nullptr);
}

/**
 * @tc.name: GotComposerToRenderConnByToken001
 * @tc.desc: Test GotComposerToRenderConnByToken throws when pid not found
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSMultiRenderProcessManagerTest, GotComposerToRenderConnByToken001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
...
/**
 * @tc.name: GotServiceToRenderConnByToken001
 * @tc.desc: Test GotServiceToRenderConnByToken throws when pid not found
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSMultiRenderProcessManagerTest, GotServiceToRenderConnByToken001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    auto conn = multiProcessManager_->GetServiceToRenderConnByToken(TEST_TOKEN);
...
/**
 * @tc.name: GotConnectToRenderConnByToken001
 * @tc.desc: Test GotConnectToRenderConnByToken throws when pid not found
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSMultiRenderProcessManagerTest, GotConnectToRenderConnByToken001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    auto conn = multiProcessManager_->GetConnectToRenderConnByToken(TEST_TOKEN);
    ASSERT_EQ(conn, nullptr);
...
HWTEST_F(RSMultiRenderProcessManagerTest, OnScreenDisconnected002, TestSize.Level1)
{
    ...
    multiProcessManager_->UpdateGroupIdToRenderProcessToken(TEST_GROUP_ID, TEST_TOKEN);
    multiProcessManager_->OnScreenDisconnected(TEST_SCREEN_ID);
    multiProcessManager_->groupIdToRenderProcessToken_.erase(TEST_GROUP_ID);
    renderService_->renderModeConfig_ = nullptr;
}
...
/**
 * @tc.name: GetComposerToRenderConnByToken001
 * @tc.desc: Test GetComposerToRenderConnByToken returns nullptr when not found
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSMultiRenderProcessManagerTest, GetComposerToRenderConnByToken001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    auto conn = multiProcessManager_->GetComposerToRenderConnByToken(TEST_TOKEN);
    EXPECT_EQ(conn, nullptr);
}

/**
 * @tc.name: GetComposerToRenderConnByToken002
 * @tc.desc: Test GetComposerToRenderConnByToken returns connection when found
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSMultiRenderProcessManagerTest, GetComposerToRenderConnByToken002, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
...
/**
 * @tc.name: GetComposerToRenderConnByTokenLocked001
 * @tc.desc: Test GetComposerToRenderConnByTokenLocked returns nullptr when not found
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSMultiRenderProcessManagerTest, GetComposerToRenderConnByTokenLocked001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    auto conn = multiProcessManager_->GetComposerToRenderConnByTokenLocked(TEST_TOKEN);
    EXPECT_EQ(conn, nullptr);
}

/**
 * @tc.name: GetComposerToRenderConnByTokenLocked002
 * @tc.desc: Test GetComposerToRenderConnByTokenLocked returns nullptr when found but value is nullptr
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSMultiRenderProcessManagerTest, GetComposerToRenderConnByTokenLocked002, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    sptr<IRSComposerToRenderConnection> storedConn = nullptr;
    multiProcessManager_->composerToRenderConnections_[TEST_TOKEN] = storedConn;
...
/**
 * @tc.name: GetComposerToRenderConnByTokenLocked003
 * @tc.desc: Test GetComposerToRenderConnByTokenLocked returns non-nullptr when found with valid value
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSMultiRenderProcessManagerTest, GetComposerToRenderConnByTokenLocked003, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
...
HWTEST_F(RSMultiRenderProcessManagerTest, HandleRenderProcessDeath001, TestSize.Level1)
{
    ...
    multiProcessManager_->groupIdToRenderProcessToken_[TEST_GROUP_ID] = TEST_TOKEN;
    auto output = std::make_shared<HdiOutput>(TEST_SCREEN_ID);
    multiProcessManager_->processToScreenOutputMap_[TEST_TOKEN].emplace_back(TEST_SCREEN_ID, output);
    ...
    EXPECT_EQ(multiProcessManager_->composerToRenderConnections_.count(TEST_TOKEN), 0u);
    EXPECT_EQ(multiProcessManager_->groupIdToRenderProcessToken_.count(TEST_GROUP_ID), 0u);
    EXPECT_EQ(multiProcessManager_->processToScreenOutputMap_.count(TEST_TOKEN), 0u);
}
...
HWTEST_F(RSMultiRenderProcessManagerTest, SetRenderProcessReadyPromise001, TestSize.Level1)
{
    ...
    localManager->AddValidRenderProcessToken(TEST_TOKEN);
    auto pipeline = std::make_shared<RSRenderPipeline>();
    auto renderPipelineAgent = sptr<RSRenderPipelineAgent>::MakeSptr(pipeline);
...
HWTEST_F(RSMultiRenderProcessManagerTest, HandleExistingGroup005, TestSize.Level1)
{
    ...
    localRenderService->renderModeConfig_ = RenderModeConfigBuilder()
        ...
        .SetScreenIdToGroupId(TEST_SCREEN_ID, TEST_GROUP_ID)
        .Build();
    localManager->UpdateGroupIdToRenderProcessToken(TEST_GROUP_ID, TEST_TOKEN);
    auto pipeline = std::make_shared<RSRenderPipeline>();
    auto renderPipelineAgent = sptr<RSRenderPipelineAgent>::MakeSptr(pipeline);
    sptr<RSServiceToRenderConnection> serviceConn = sptr<RSServiceToRenderConnection>::MakeSptr(renderPipelineAgent);
    ...
    localManager->groupIdToRenderProcessToken_.erase(TEST_GROUP_ID);
    localManager->serviceToRenderConnections_.erase(TEST_TOKEN);
...
HWTEST_F(RSMultiRenderProcessManagerTest, OnRemoteDiedNormalPath001, TestSize.Level1)
{
    ...
    localManager->groupIdToRenderProcessToken_[TEST_GROUP_ID] = TEST_TOKEN;
    auto output = std::make_shared<HdiOutput>(TEST_SCREEN_ID);
    ...
    EXPECT_EQ(localManager->groupIdToRenderProcessToken_.count(TEST_GROUP_ID), 0u);
...
HWTEST_F(RSMultiRenderProcessManagerTest, GetRenderProcessTokenByGroupId001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    auto result = multiProcessManager_->GetRenderProcessTokenByGroupId(TEST_GROUP_ID);
    EXPECT_FALSE(result.has_value());
...
HWTEST_F(RSMultiRenderProcessManagerTest, GetRenderProcessTokenByGroupId002, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    multiProcessManager_->UpdateGroupIdToRenderProcessToken(TEST_GROUP_ID, TEST_TOKEN);
    auto result = multiProcessManager_->GetRenderProcessTokenByGroupId(TEST_GROUP_ID);
...
HWTEST_F(RSMultiRenderProcessManagerTest, GetRenderProcessTokenByGroupIdLocked001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    auto result = multiProcessManager_->GetRenderProcessTokenByGroupIdLocked(TEST_GROUP_ID);
    EXPECT_FALSE(result.has_value());
}

HWTEST_F(RSMultiRenderProcessManagerTest, GetRenderProcessTokenByGroupIdLocked002, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    multiProcessManager_->UpdateGroupIdToRenderProcessToken(TEST_GROUP_ID, TEST_TOKEN);
    auto result = multiProcessManager_->GetRenderProcessTokenByGroupIdLocked(TEST_GROUP_ID);
...
HWTEST_F(RSMultiRenderProcessManagerTest, UpdateGroupIdToRenderProcessTokenLocked001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    multiProcessManager_->UpdateGroupIdToRenderProcessTokenLocked(TEST_GROUP_ID, TEST_TOKEN);
    auto result = multiProcessManager_->GetRenderProcessTokenByGroupIdLocked(TEST_GROUP_ID);
    ASSERT_TRUE(result.has_value());
    EXPECT_EQ(result.value().GetPid(), TEST_PID);
    multiProcessManager_->UpdateGroupIdToRenderProcessTokenLocked(TEST_GROUP_ID, TEST_TOKEN_2);
    result = multiProcessManager_->GetRenderProcessTokenByGroupIdLocked(TEST_GROUP_ID);
    ASSERT_TRUE(result.has_value());
    EXPECT_EQ(result.value().GetPid(), TEST_PID_2);
}

HWTEST_F(RSMultiRenderProcessManagerTest, RemoveGroupIdByRenderProcessToken001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    multiProcessManager_->UpdateGroupIdToRenderProcessToken(TEST_GROUP_ID, TEST_TOKEN);
    multiProcessManager_->RemoveGroupIdByRenderProcessToken(TEST_TOKEN);
    auto result = multiProcessManager_->GetRenderProcessTokenByGroupId(TEST_GROUP_ID);
    EXPECT_FALSE(result.has_value());
}

HWTEST_F(RSMultiRenderProcessManagerTest, RemoveGroupIdByRenderProcessTokenLocked001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    multiProcessManager_->UpdateGroupIdToRenderProcessToken(TEST_GROUP_ID, TEST_TOKEN);
    multiProcessManager_->RemoveGroupIdByRenderProcessTokenLocked(TEST_TOKEN_2);
    auto result = multiProcessManager_->GetRenderProcessTokenByGroupId(TEST_GROUP_ID);
    ASSERT_TRUE(result.has_value());
}

HWTEST_F(RSMultiRenderProcessManagerTest, RemoveGroupIdByRenderProcessTokenLocked002, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    multiProcessManager_->UpdateGroupIdToRenderProcessToken(TEST_GROUP_ID, TEST_TOKEN);
    multiProcessManager_->UpdateGroupIdToRenderProcessToken(TEST_GROUP_ID_2, TEST_TOKEN);
    multiProcessManager_->RemoveGroupIdByRenderProcessTokenLocked(TEST_TOKEN);
    EXPECT_FALSE(multiProcessManager_->GetRenderProcessTokenByGroupId(TEST_GROUP_ID).has_value());
    EXPECT_FALSE(multiProcessManager_->GetRenderProcessTokenByGroupId(TEST_GROUP_ID_2).has_value());
}

HWTEST_F(RSMultiRenderProcessManagerTest, GetValidRenderProcessTokenByPid001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    auto result = multiProcessManager_->GetValidRenderProcessTokenByPid(TEST_PID);
    EXPECT_FALSE(result.has_value());
}

HWTEST_F(RSMultiRenderProcessManagerTest, GetValidRenderProcessTokenByPid002, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    multiProcessManager_->AddValidRenderProcessToken(TEST_TOKEN);
    auto result = multiProcessManager_->GetValidRenderProcessTokenByPid(TEST_PID);
...
HWTEST_F(RSMultiRenderProcessManagerTest, GetValidRenderProcessTokenByPidLocked001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    auto result = multiProcessManager_->GetValidRenderProcessTokenByPidLocked(TEST_PID);
    EXPECT_FALSE(result.has_value());
}

HWTEST_F(RSMultiRenderProcessManagerTest, GetValidRenderProcessTokenByPidLocked002, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    multiProcessManager_->AddValidRenderProcessToken(TEST_TOKEN);
    auto result = multiProcessManager_->GetValidRenderProcessTokenByPidLocked(TEST_PID);
...
HWTEST_F(RSMultiRenderProcessManagerTest, AddValidRenderProcessToken001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    multiProcessManager_->AddValidRenderProcessToken(TEST_TOKEN);
    EXPECT_EQ(multiProcessManager_->validRenderProcessTokens_.count(TEST_TOKEN), 1u);
}

HWTEST_F(RSMultiRenderProcessManagerTest, RemoveValidRenderProcessToken001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    multiProcessManager_->AddValidRenderProcessToken(TEST_TOKEN);
    multiProcessManager_->RemoveValidRenderProcessToken(TEST_TOKEN);
    EXPECT_EQ(multiProcessManager_->validRenderProcessTokens_.count(TEST_TOKEN), 0u);
}

HWTEST_F(RSMultiRenderProcessManagerTest, IsValidRenderProcessTokenLocked001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    EXPECT_FALSE(multiProcessManager_->IsValidRenderProcessTokenLocked(TEST_TOKEN));
    multiProcessManager_->AddValidRenderProcessToken(TEST_TOKEN);
    EXPECT_TRUE(multiProcessManager_->IsValidRenderProcessTokenLocked(TEST_TOKEN));
}

HWTEST_F(RSMultiRenderProcessManagerTest, GetServiceToRenderConnByToken002Found, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    auto pipeline = std::make_shared<RSRenderPipeline>();
    auto renderPipelineAgent = sptr<RSRenderPipelineAgent>::MakeSptr(pipeline);
...
HWTEST_F(RSMultiRenderProcessManagerTest, GetServiceToRenderConnByTokenLocked002Found, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    auto pipeline = std::make_shared<RSRenderPipeline>();
    auto renderPipelineAgent = sptr<RSRenderPipelineAgent>::MakeSptr(pipeline);
...
HWTEST_F(RSMultiRenderProcessManagerTest, GotServiceToRenderConnByToken002Valid, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    multiProcessManager_->AddValidRenderProcessToken(TEST_TOKEN);
    auto pipeline = std::make_shared<RSRenderPipeline>();
    ...
    sptr<RSServiceToRenderConnection> serviceConn =
        sptr<RSServiceToRenderConnection>::MakeSptr(renderPipelineAgent);
    multiProcessManager_->serviceToRenderConnections_[TEST_TOKEN] = serviceConn;
    auto conn = multiProcessManager_->GotServiceToRenderConnByToken(TEST_TOKEN);
    ASSERT_NE(conn, nullptr);
    multiProcessManager_->serviceToRenderConnections_.erase(TEST_TOKEN);
}

HWTEST_F(RSMultiRenderProcessManagerTest, GotConnectToRenderConnByToken002Valid, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    multiProcessManager_->AddValidRenderProcessToken(TEST_TOKEN);
    auto pipeline = std::make_shared<RSRenderPipeline>();
    ...
    auto conn = multiProcessManager_->GotConnectToRenderConnByToken(TEST_TOKEN);
    ASSERT_NE(conn, nullptr);
    multiProcessManager_->connectToRenderConnections_.erase(TEST_TOKEN);
}

HWTEST_F(RSMultiRenderProcessManagerTest, GotComposerToRenderConnByToken002Valid, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    multiProcessManager_->AddValidRenderProcessToken(TEST_TOKEN);
    sptr<IRSComposerToRenderConnection> storedConn = sptr<RSComposerToRenderConnection>::MakeSptr();
    multiProcessManager_->composerToRenderConnections_[TEST_TOKEN] = storedConn;
    auto conn = multiProcessManager_->GotComposerToRenderConnByToken(TEST_TOKEN);
    ASSERT_NE(conn, nullptr);
    multiProcessManager_->composerToRenderConnections_.erase(TEST_TOKEN);
}
...
HWTEST_F(RSMultiRenderProcessManagerTest, UnregisterDeathRecipient001, TestSize.Level1)
{
    ...
    auto renderPipelineAgent = sptr<RSRenderPipelineAgent>::MakeSptr(pipeline);
    auto oldRecipient = sptr<RSMultiRenderProcessManager::RenderProcessDeathRecipient>::MakeSptr(
        TEST_TOKEN, wptr<RSMultiRenderProcessManager>(multiProcessManager_));
    multiProcessManager_->deathRecipients_[TEST_TOKEN] = oldRecipient;
    multiProcessManager_->UnregisterDeathRecipient(TEST_TOKEN);
    EXPECT_EQ(multiProcessManager_->deathRecipients_.count(TEST_TOKEN), 0u);
}

HWTEST_F(RSMultiRenderProcessManagerTest, UnregisterDeathRecipientLocked001, TestSize.Level1)
{
    ASSERT_NE(multiProcessManager_, nullptr);
    multiProcessManager_->UnregisterDeathRecipientLocked(TEST_TOKEN);
    EXPECT_EQ(multiProcessManager_->deathRecipients_.size(), 0u);
}
...
HWTEST_F(RSMultiRenderProcessManagerTest, ProcessTokenEquality001, TestSize.Level1)
{
    ProcessToken token1{TEST_PID, TEST_TIMESTAMP};
    ProcessToken token2{TEST_PID, TEST_TIMESTAMP};
    ProcessToken token3{TEST_PID_2, TEST_TIMESTAMP};
    ProcessToken token4{TEST_PID, TEST_TIMESTAMP_2};
    EXPECT_TRUE(token1 == token2);
    EXPECT_FALSE(token1 == token3);
    EXPECT_FALSE(token1 == token4);
    ProcessToken::Hash hasher;
    EXPECT_EQ(hasher(token1), hasher(token2));
}

HWTEST_F(RSMultiRenderProcessManagerTest, ProcessTokenInContainers001, TestSize.Level1)
{
    std::unordered_set<ProcessToken, ProcessToken::Hash> tokenSet;
    ...
    std::unordered_map<ProcessToken, int, ProcessToken::Hash> tokenMap;
