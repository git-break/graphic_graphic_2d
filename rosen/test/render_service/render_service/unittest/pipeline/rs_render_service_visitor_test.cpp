...
/**
 * @tc.name: SortZOrder001
 * @tc.desc:
 * @tc.type:
 * @tc.require:
 * @tc.author:
 */
HWTEST_F(RSRenderServiceVisitorTest, SortZOrder001, TestSize.Level1)
{
    constexpr NodeId nodeId = TestSrc::limitNumber::Uint64[1];
    RSRenderServiceVisitor rsRenderServiceVisitor;
    RSBaseRenderNode node(nodeId);
    rsRenderServiceVisitor.SortZOrder(node);
}

/**
 * @tc.name: SortZOrder002
 * @tc.desc:
 * @tc.type:
 * @tc.require:
 * @tc.author:
 */
HWTEST_F(RSRenderServiceVisitorTest, SortZOrder002, TestSize.Level1)
{
    constexpr NodeId nodeId = TestSrc::limitNumber::Uint64[2];
    RSRenderServiceVisitor rsRenderServiceVisitor;
    RSBaseRenderNode node(nodeId);
...
/**
 * @tc.name: SortZOrder003
 * @tc.desc:
 * @tc.type:
 * @tc.require:
 * @tc.author:
 */
HWTEST_F(RSRenderServiceVisitorTest, SortZOrder003, TestSize.Level1)
{
    constexpr NodeId nodeId = TestSrc::limitNumber::Uint64[3];
    RSRenderServiceVisitor rsRenderServiceVisitor;
    RSBaseRenderNode node(nodeId);
...
/**
 * @tc.name: SortZOrder004
 * @tc.desc:
 * @tc.type:
 * @tc.require:
 * @tc.author:
 */
HWTEST_F(RSRenderServiceVisitorTest, SortZOrder004, TestSize.Level1)
{
    constexpr NodeId nodeId = TestSrc::limitNumber::Uint64[4];
    RSRenderServiceVisitor rsRenderServiceVisitor;
    RSBaseRenderNode node(nodeId);
...
/**
 * @tc.name: SortZOrder005
 * @tc.desc:
 * @tc.type:
 * @tc.require:
 * @tc.author:
 */
HWTEST_F(RSRenderServiceVisitorTest, SortZOrder005, TestSize.Level1)
{
    constexpr NodeId nodeId = TestSrc::limitNumber::Uint64[5];
    RSRenderServiceVisitor rsRenderServiceVisitor;
    RSBaseRenderNode node(nodeId);
...
/**
 * @tc.name: SortZOrder006
 * @tc.desc:
 * @tc.type:
 * @tc.require:
 * @tc.author:
 */
HWTEST_F(RSRenderServiceVisitorTest, SortZOrder006, TestSize.Level1)
{
    constexpr NodeId nodeId = TestSrc::limitNumber::Uint64[6];
    RSRenderServiceVisitor rsRenderServiceVisitor;
    RSBaseRenderNode node(nodeId);
...
/**
 * @tc.name: SortZOrder007
 * @tc.desc:
 * @tc.type:
 * @tc.require:
 * @tc.author:
 */
HWTEST_F(RSRenderServiceVisitorTest, SortZOrder007, TestSize.Level1)
{
    constexpr NodeId nodeId = TestSrc::limitNumber::Uint64[7];
    RSRenderServiceVisitor rsRenderServiceVisitor;
    RSBaseRenderNode node(nodeId);
...
/**
 * @tc.name: SortZOrder008
 * @tc.desc:
 * @tc.type:
 * @tc.require:
 * @tc.author:
 */
HWTEST_F(RSRenderServiceVisitorTest, SortZOrder008, TestSize.Level1)
{
    constexpr NodeId nodeId = TestSrc::limitNumber::Uint64[0];
    RSRenderServiceVisitor rsRenderServiceVisitor;
    RSBaseRenderNode node(nodeId);
