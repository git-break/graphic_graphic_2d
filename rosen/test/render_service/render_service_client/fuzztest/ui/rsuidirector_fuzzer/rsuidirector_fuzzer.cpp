...
const uint8_t DO_INIT = ;
const uint8_t DO_START_TEXTURE_EXPORT = 3;
const uint8_t DO_DESTROY = 4;
const uint8_t DO_SET_RSSURFACE_NODE = 5;
const uint8_t DO_SET_ABILITY_BG_ALPHA = 6;
const uint8_t DO_SET_RTRENDER_FORCED = 7;
const uint8_t DO_SET_CONTAINER_WINDOW = 8;
const uint8_t DO_SET_FLUSH_EMPTY_CALLBACK = 9;
const uint8_t DO_SET_ROOT = 10;
const uint8_t DO_SET_UITASK_RUNNER = 11;
const uint8_t DO_SEND_MESSAGES = 12;
const uint8_t DO_SET_TIMESTAMP = 13;
const uint8_t DO_SET_CACHE_DIR = 14;
const uint8_t DO_FLUSH_ANIMATION = 15;
const uint8_t DO_FLUSH_MODIFIER = 16;
const uint8_t DO_HAS_UI_ANIMATION = 17;
const uint8_t DO_FLUSH_ANIMATION_START_TIME = 18;
const uint8_t DO_SET_APP_FREEZE = 19;
const uint8_t DO_SET_REQUEST_VSYNC_CALLBACK = 20;
const uint8_t DO_POST_FRAME_RATE_TASK = 21;
const uint8_t DO_GET_CURRENT_REFRESH_RATE_MODE = 22;
const uint8_t DO_GET_ANIMATE_EXPECTED_RATE = 23;
const uint8_t DO_ATTACH_SURFACE = 24;
const uint8_t DO_RECV_MESSAGES_001 = 25;
const uint8_t DO_RECV_MESSAGES_002 = 26;
const uint8_t DO_PROCESS_MESSAGES = 27;
const uint8_t DO_ANIMATION_CALLBACK_PROCESSOR = 28;
const uint8_t DO_POST_TASK = 29;
const uint8_t DO_HAS_FIRST_FRAME_ANIMATION = 30;
const uint8_t DO_HAS_UIRUNNING_ANIMATION = 31;
const uint8_t DO_GET_INDEX = 32;
const uint8_t DO_DUMP_NODE_TREE_PROCESSOR = 33;
const uint8_t DO_POST_DELAY_TASK = 34;
const uint8_t TARGET_SIZE = 35;
