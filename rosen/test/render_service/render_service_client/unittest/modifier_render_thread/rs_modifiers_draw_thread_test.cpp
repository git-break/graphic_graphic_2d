 ...
 * @tc.desc: test results of ConvertTransaction of not ABILITY_OR_PAGE_SWITCH implicitAnimator scene
 * @tc.type: FUNC
 * @tc.require: issuesICNX7C
 */
HWTEST_F(RSModifiersDrawThreadTest, ConvertTransactionTest012, TestSize.Level1)
{
    NodeId nodeId = 1;
    uint16_t propertyId = 1;
    auto transactionData = std::make_unique<RSTransactionData>();
    int opCnt = DEFAULT_MODIFIERS_DRAW_THREAD_LOOP_NUM - 1;
    for (int i = 0; i < opCnt; i++) {
        auto cmdList = std::make_shared<Drawing::DrawCmdList>();
        cmdList->SetHybridRenderType(Drawing::DrawCmdList::HybridRenderType::HMSYMBOL);
        Drawing::Brush brush;
 ...
 * @tc.require: issuesICNX7C
 */
HWTEST_F(RSModifiersDrawThreadTest, ConvertTransactionTest013, TestSize.Level1)
{
    NodeId nodeId = 1;
    uint16_t propertyId = 1;
    auto transactionData = std::make_unique<RSTransactionData>();
    int opCnt = DEFAULT_MODIFIERS_DRAW_THREAD_LOOP_NUM;
    for (int i = 0; i < opCnt; i++) {
        auto cmdList = std::make_shared<Drawing::DrawCmdList>();
        cmdList->SetHybridRenderType(Drawing::DrawCmdList::HybridRenderType::HMSYMBOL);
        Drawing::Brush brush;
...
/**
 * @tc.name: ConvertTransactionTest014
 * @tc.desc: test results of ConvertTransaction of not ABILITY_OR_PAGE_SWITCH implicitAnimator scene
 * @tc.type: FUNC
 * @tc.require: issuesICNX7C
 */
HWTEST_F(RSModifiersDrawThreadTest, ConvertTransactionTest014, TestSize.Level1)
{
    NodeId nodeId = 1;
    uint16_t propertyId = 1;
    auto transactionData = std::make_unique<RSTransactionData>();
...
/**
 * @tc.name: ConvertTransactionTest015
 * @tc.desc: test results of ConvertTransaction of ABILITY_OR_PAGE_SWITCH implicitAnimator scene
 * @tc.type: FUNC
 * @tc.require: issuesICNX7C
 */
HWTEST_F(RSModifiersDrawThreadTest, ConvertTransactionTest015, TestSize.Level1)
{
    NodeId nodeId = 1;
    uint16_t propertyId = 1;
    auto transactionData = std::make_unique<RSTransactionData>();
