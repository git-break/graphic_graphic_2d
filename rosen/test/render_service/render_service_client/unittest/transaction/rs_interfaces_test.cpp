...
/**
 * @tc.name: CollectImplicitAnimatorInfo001
 * @tc.desc: test results of CollectImplicitAnimatorInfo with default param
 * @tc.type: FUNC
 * @tc.require: issuesICNX7C
 */
HWTEST_F(RSInterfacesTest, CollectImplicitAnimatorInfo001, TestSize.Level1)
{
    RSInterfaces& instance = RSInterfaces::GetInstance();
    DataBaseRs info;
    bool isImplicitAnimatorScene = false;
    RSSystemProperties::SetImplicitAnimatorScene(isImplicitAnimatorScene);
    instance.CollectImplicitAnimatorInfo(info);
    EXPECT_EQ(RSSystemProperties::GetImplicitAnimatorScene(), isImplicitAnimatorScene);
}

/**
 * @tc.name: CollectImplicitAnimatorInfo002
 * @tc.desc: test results of CollectImplicitAnimatorInfo with not ABILITY_OR_PAGE_SWITCH ImplicitAnimator scene
 * @tc.type: FUNC
 * @tc.require: issuesICNX7C
 */
HWTEST_F(RSInterfacesTest, CollectImplicitAnimatorInfo002, TestSize.Level1)
{
    RSInterfaces& instance = RSInterfaces::GetInstance();
    DataBaseRs info;
    info.isDisplayAnimator = true;
    bool isImplicitAnimatorScene = false;
    RSSystemProperties::SetImplicitAnimatorScene(isImplicitAnimatorScene);
    instance.CollectImplicitAnimatorInfo(info);
    EXPECT_EQ(RSSystemProperties::GetImplicitAnimatorScene(), isImplicitAnimatorScene);
...
/**
 * @tc.name: CollectImplicitAnimatorInfo003
 * @tc.desc: test results of CollectImplicitAnimatorInfo with not ABILITY_OR_PAGE_SWITCH ImplicitAnimator scene
 * @tc.type: FUNC
 * @tc.require: issuesICNX7C
 */
HWTEST_F(RSInterfacesTest, CollectImplicitAnimatorInfo003, TestSize.Level1)
{
    RSInterfaces& instance = RSInterfaces::GetInstance();
    DataBaseRs info;
    info.sceneId = "ABILITY_OR_PAGE_SWITCH";
    info.isDisplayAnimator = true;
    bool isImplicitAnimatorScene = false;
    RSSystemProperties::SetImplicitAnimatorScene(isImplicitAnimatorScene);
    instance.CollectImplicitAnimatorInfo(info);
...
/**
 * @tc.name: CollectImplicitAnimatorInfo004
 * @tc.desc: test results of CollectImplicitAnimatorInfo with ABILITY_OR_PAGE_SWITCH ImplicitAnimator scene
 * @tc.type: FUNC
 * @tc.require: issuesICNX7C
 */
HWTEST_F(RSInterfacesTest, CollectImplicitAnimatorInfo004, TestSize.Level1)
{
    RSInterfaces& instance = RSInterfaces::GetInstance();
    DataBaseRs info;
    info.sceneId = "ABILITY_OR_PAGE_SWITCH";
    info.isDisplayAnimator = false;
    bool isImplicitAnimatorScene = false;
    RSSystemProperties::SetImplicitAnimatorScene(isImplicitAnimatorScene);
    instance.CollectImplicitAnimatorInfo(info);
    EXPECT_NE(RSSystemProperties::GetImplicitAnimatorScene(), isImplicitAnimatorScene);
}
