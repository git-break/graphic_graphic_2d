 ...
 */
HWTEST_F(RSRenderEngineTest, ResetCurrentContextTest, TestSize.Level1)
{
 ...
 * @tc.require: issueI6GJ1Z
 */
HWTEST_F(RSRenderEngineTest, SetHighContrast_001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderEngineTest, NeedBilinearInterpolation, TestSize.Level1)
{
    BufferDrawParam params;
 ...
 */
HWTEST_F(RSRenderEngineTest, SetColorSpaceConverterDisplayParameterTest, TestSize.Level1)
{
#ifdef USE_VIDEO_PROCESSING_ENGINE
    auto renderEngine = std::make_shared<RSRenderEngine>();
    auto surfaceNode = RSTestUtil::CreateSurfaceNodeWithBuffer();
 ...
 * @tc.require:issueIC1RNF
 */
HWTEST_F(RSRenderEngineTest, ConvertColorSpaceNameToDrawingColorSpaceTest, TestSize.Level1)
{
    auto renderEngine = std::make_shared<RSRenderEngine>();
 ...
 * @tc.require:issueIC1RNF
 */
HWTEST_F(RSRenderEngineTest, ShrinkCachesIfNeededTest, TestSize.Level1)
{
    auto renderEngine = std::make_shared<RSRenderEngine>();
#ifdef RS_ENABLE_VK
 ...
 */
HWTEST_F(RSRenderEngineTest, CheckAndVerifyDamageRegion001, TestSize.Level1)
{
 ...
 * @tc.require:issueIC1RNF
 */
HWTEST_F(RSRenderEngineTest, DumpVkImageInfoTest, TestSize.Level1)
{
    auto renderEngine = std::make_shared<RSRenderEngine>();
 ...
 * @tc.require:issueIC1RNF
 */
HWTEST_F(RSRenderEngineTest, ShrinkCachesIfNeededTest002, TestSize.Level1)
{
    auto renderEngine = std::make_shared<RSRenderEngine>();
    renderEngine->ShrinkCachesIfNeeded();
    renderEngine->Init();
