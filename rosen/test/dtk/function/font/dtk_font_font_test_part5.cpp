...
// 对应用例 font_font_3321
DEF_DTK(font_font_5, TestLevel::L2, 321)
{
    // 创建typeface
...
// 对应用例 font_font_3322
DEF_DTK(font_font_5, TestLevel::L2, 322)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3323
DEF_DTK(font_font_5, TestLevel::L2, 323)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3324
DEF_DTK(font_font_5, TestLevel::L2, 324)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3325
DEF_DTK(font_font_5, TestLevel::L2, 325)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3326
DEF_DTK(font_font_5, TestLevel::L2, 326)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3327
DEF_DTK(font_font_5, TestLevel::L2, 327)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3328
DEF_DTK(font_font_5, TestLevel::L2, 328)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3329
DEF_DTK(font_font_5, TestLevel::L2, 329)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3330
DEF_DTK(font_font_5, TestLevel::L2, 330)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3331
DEF_DTK(font_font_5, TestLevel::L2, 331)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3332
DEF_DTK(font_font_5, TestLevel::L2, 332)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3333
DEF_DTK(font_font_5, TestLevel::L2, 333)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3334
DEF_DTK(font_font_5, TestLevel::L2, 334)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3335
DEF_DTK(font_font_5, TestLevel::L2, 335)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3336
DEF_DTK(font_font_5, TestLevel::L2, 336)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3337
DEF_DTK(font_font_5, TestLevel::L2, 337)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3338
DEF_DTK(font_font_5, TestLevel::L2, 338)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3339
DEF_DTK(font_font_5, TestLevel::L2, 339)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3340
DEF_DTK(font_font_5, TestLevel::L2, 340)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3341
DEF_DTK(font_font_5, TestLevel::L2, 341)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3342
DEF_DTK(font_font_5, TestLevel::L2, 342)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3343
DEF_DTK(font_font_5, TestLevel::L2, 343)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3344
DEF_DTK(font_font_5, TestLevel::L2, 344)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3345
DEF_DTK(font_font_5, TestLevel::L2, 345)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3346
DEF_DTK(font_font_5, TestLevel::L2, 346)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3347
DEF_DTK(font_font_5, TestLevel::L2, 347)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3348
DEF_DTK(font_font_5, TestLevel::L2, 348)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3349
DEF_DTK(font_font_5, TestLevel::L2, 349)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3350
DEF_DTK(font_font_5, TestLevel::L2, 350)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
