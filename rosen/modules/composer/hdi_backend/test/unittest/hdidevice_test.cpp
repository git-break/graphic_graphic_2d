...
HWTEST_F(HdiDeviceTest, DeviceFuncs001, Function | MediumTest| Level3)
{
    ...
    EXPECT_CALL(*hdiDeviceMock_,SetScreenPowerStatus(_, _).WillRepeatedly(testing::Return(GRAPHIC_DISPLAY_SUCCESS)));
    EXPECT_CALL(*hdiDeviceMock_,GetScreenPowerStatus(_, _).WillRepeatedly(testing::Return(GRAPHIC_DISPLAY_SUCCESS)));
    EXPECT_CALL(*hdiDeviceMock_,GetScreenBacklight(_, _).WillRepeatedly(testing::Return(GRAPHIC_DISPLAY_SUCCESS)));
    EXPECT_CALL(*hdiDeviceMock_,
