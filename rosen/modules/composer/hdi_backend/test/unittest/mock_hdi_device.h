...
public:
    ...
    MOCK_METHOD5(GetDisplayVCPFeature, int32_t(uint32_t, uint8_t, uint16_t&, uint16_t&, int32_t&));
    MOCK_METHOD3(SetDisplayVCPFeature, int32_t(uint32_t, uint8_t, uint16_t));
