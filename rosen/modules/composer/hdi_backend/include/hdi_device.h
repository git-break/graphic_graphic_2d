...
public:
    ...
    virtual int32_t CommitAndGetReleaseFence(uint32_t screenId, sptr<SyncFence> &fence, int32_t &skipState, bool &needFlush,
        std::vector<uint32_t>& layers, std::vector<sptr<SyncFence>>& fences) = 0;
