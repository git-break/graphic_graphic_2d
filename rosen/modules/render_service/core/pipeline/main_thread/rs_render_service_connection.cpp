...
{
    RS_TRACE_NAME_FMT("789 test 6. call manager, timeStamp: %" PRIu64 " pid: %d", timeStamp, pid);
    RS_LOGD("789 test 6. call manager, timeStamp: %{public}" PRIu64 " pid: %{public}d", timeStamp, pid);
