    ...
    const Drawing::Rect& specifiedAreaRect, RSSurfaceCapturePermissions permissions)
{
    ...
    std::function<void()> captureTask = [id, callback, captureConfig, blurParam, specifiedAreaRect,
        ...
        RS_TRACE_NAME_FMT("RSRenderService::TakeSurfaceCapture captureTask nodeId:[%" PRIu64 "]", id);
        RS_LOGI("RSRenderService::TakeSurfaceCapture captureTask begin nodeId:[%{public}" PRIu64 "]", id);
