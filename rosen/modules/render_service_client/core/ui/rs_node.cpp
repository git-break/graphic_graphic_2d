...
void RSNode::SetBoundsAndFrame(float positionX, float positionY, float width, float height, float frameX, float frameY)
{
    SetBoundsAndFrame({ positionX, positionY, width, height }, { frameX, frameY, width, height });
}
