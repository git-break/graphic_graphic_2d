...
int32_t RSInterfaces::SetVirtualScreenSecurityMask(ScreenId id, const std::shared_ptr<Media::PixelMap>& securityMaskImg)
{
    return renderServiceClient_->SetVirtualScreenSecurityMask(id, securityMaskImg);
}
