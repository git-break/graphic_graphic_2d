...
template<>
inline const RSPropertyType RSProperty<std::shared_ptr<OHOS::Media::PixelMap>>::type_ = RSPropertyType::PIXEL_MAP;
template<>
inline const RSPropertyType RSProperty<RSDynamicBrightnessPara>::type_ = RSPropertyType::DYNAMIC_BRIGHTNESS_PARA;
template<>
inline const RSPropertyType RSProperty<std::shared_ptr<RSRenderFilter>>::type_ = RSPropertyType::RS_RENDER_FILTER;
template<>
inline const RSPropertyType RSProperty<std::vector<float>>::type_ = RSPropertyType::VECTOR_FLOAT;
} // namespace Rosen
} // namespace OHOS
