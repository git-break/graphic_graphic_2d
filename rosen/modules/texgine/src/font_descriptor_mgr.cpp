...
void FontDescriptorMgr::CacheDynamicTypeface(std::shared_ptr<Drawing::Typeface> typeface)
{
    if (typeface == nullptr) {
        return;
    }
...
void FontDescriptorMgr::DeleteDynamicTypefaceFromCache(std::shared_ptr<Drawing::Typeface> typeface)
{
    if (typeface == nullptr) {
        return;
    }
