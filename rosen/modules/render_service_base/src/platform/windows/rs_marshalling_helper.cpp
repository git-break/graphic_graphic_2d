...
// RSNGRenderMaskBase
bool RSMarshallingHelper::Marshalling(Parcel& parcel, const std::shared_ptr<RSNGRenderEffectBase>& val)
{
    return {};
}

bool RSMarshallingHelper::Unmarshalling(Parcel& parcel, std::shared_ptr<RSNGRenderEffectBase>& val)
{
    return {};
}
