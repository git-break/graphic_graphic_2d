...
static const std::unordered_map<ModifierNG::RSModifierType, RSPropertyDrawableSlot> g_propertyToDrawableLutNG = {
    { ModifierNG::RSModifierType::INVALID,                      RSPropertyDrawableSlot::INVALID },
    { ModifierNG::RSModifierType::BOUNDS,                       RSPropertyDrawableSlot::CLIP_TO_BOUNDS },
    { ModifierNG::RSModifierType::FRAME,                        RSPropertyDrawableSlot::FRAME_OFFSET },
    { ModifierNG::RSModifierType::TRANSFORM,                    RSPropertyDrawableSlot::INVALID },
    { ModifierNG::RSModifierType::ALPHA,                        RSPropertyDrawableSlot::INVALID },
    { ModifierNG::RSModifierType::FOREGROUND_COLOR,             RSPropertyDrawableSlot::FOREGROUND_COLOR },
    { ModifierNG::RSModifierType::BACKGROUND_COLOR,             RSPropertyDrawableSlot::BACKGROUND_COLOR },
    { ModifierNG::RSModifierType::BACKGROUND_SHADER,            RSPropertyDrawableSlot::BACKGROUND_SHADER },
    { ModifierNG::RSModifierType::BACKGROUND_IMAGE,             RSPropertyDrawableSlot::BACKGROUND_IMAGE },
    { ModifierNG::RSModifierType::BORDER,                       RSPropertyDrawableSlot::BORDER },
    { ModifierNG::RSModifierType::OUTLINE,                      RSPropertyDrawableSlot::OUTLINE },
    { ModifierNG::RSModifierType::CLIP_TO_BOUNDS,               RSPropertyDrawableSlot::CLIP_TO_BOUNDS },
    { ModifierNG::RSModifierType::CLIP_TO_FRAME,                RSPropertyDrawableSlot::CLIP_TO_FRAME },
    { ModifierNG::RSModifierType::VISIBILITY,                   RSPropertyDrawableSlot::INVALID },
    { ModifierNG::RSModifierType::DYNAMIC_LIGHT_UP,             RSPropertyDrawableSlot::DYNAMIC_LIGHT_UP },
    { ModifierNG::RSModifierType::SHADOW,                       RSPropertyDrawableSlot::SHADOW },
    { ModifierNG::RSModifierType::MASK,                         RSPropertyDrawableSlot::MASK },
    { ModifierNG::RSModifierType::PIXEL_STRETCH,                RSPropertyDrawableSlot::PIXEL_STRETCH },
    { ModifierNG::RSModifierType::USE_EFFECT,                   RSPropertyDrawableSlot::USE_EFFECT },
    { ModifierNG::RSModifierType::BLENDER,                      RSPropertyDrawableSlot::BLEND_MODE },
    { ModifierNG::RSModifierType::POINT_LIGHT,                  RSPropertyDrawableSlot::POINT_LIGHT },
    { ModifierNG::RSModifierType::PARTICLE_EFFECT,              RSPropertyDrawableSlot::PARTICLE_EFFECT },
    { ModifierNG::RSModifierType::COMPOSITING_FILTER,           RSPropertyDrawableSlot::COMPOSITING_FILTER },
    { ModifierNG::RSModifierType::BACKGROUND_FILTER,            RSPropertyDrawableSlot::BACKGROUND_FILTER },
    { ModifierNG::RSModifierType::FOREGROUND_FILTER,            RSPropertyDrawableSlot::FOREGROUND_FILTER },
    { ModifierNG::RSModifierType::TRANSITION_STYLE,             RSPropertyDrawableSlot::TRANSITION },
    { ModifierNG::RSModifierType::BACKGROUND_STYLE,             RSPropertyDrawableSlot::BACKGROUND_STYLE },
    { ModifierNG::RSModifierType::CONTENT_STYLE,                RSPropertyDrawableSlot::CONTENT_STYLE },
    { ModifierNG::RSModifierType::FOREGROUND_STYLE,             RSPropertyDrawableSlot::FOREGROUND_STYLE },
    { ModifierNG::RSModifierType::OVERLAY_STYLE,                RSPropertyDrawableSlot::OVERLAY },
    { ModifierNG::RSModifierType::NODE_MODIFIER,                RSPropertyDrawableSlot::INVALID },
    { ModifierNG::RSModifierType::ENV_FOREGROUND_COLOR,         RSPropertyDrawableSlot::ENV_FOREGROUND_COLOR },
    { ModifierNG::RSModifierType::BEHIND_WINDOW_FILTER,         RSPropertyDrawableSlot::BACKGROUND_FILTER },
    { ModifierNG::RSModifierType::CHILDREN,                     RSPropertyDrawableSlot::CHILDREN },
};
...
std::unordered_set<RSPropertyDrawableSlot> RSPropertyDrawable::GenerateDirtySlotsNG(
    const RSProperties& properties, const ModifierNG::ModifierDirtyTypes& dirtyTypes)
{
    // Step 1.1: collect dirty slots
    std::unordered_set<RSPropertyDrawableSlot> dirtySlots;
    for (const auto& [modifierType, drawableSlot] : g_propertyToDrawableLutNG) {
        if (dirtyTypes.test(static_cast<size_t>(modifierType)) && drawableSlot != RSPropertyDrawableSlot::INVALID) {
    ...
    if (dirtyTypes.test(static_cast<size_t>(ModifierNG::RSModifierType::CLIP_TO_BOUNDS))) {
        // border may should be updated with corner radius
        if (properties.GetBorder() != nullptr) {
            dirtySlots.emplace(RSPropertyDrawableSlot::BORDER);
        }
