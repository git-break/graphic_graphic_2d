...
Drawing::RecordingCanvas::DrawFunc RSBackgroundEffectDrawable::CreateDrawFunc() const
{
    ...
    return [ptr](Drawing::Canvas* canvas, const Drawing::Rect* rect) {
        ...
        RectI deviceRect = RectI(0, 0, canvas->GetSurface()->Width(), canvas->GetSurface()->Height());
        ...
        RSPropertyDrawableUtils::DrawBackgroundEffect(
            paintFilterCanvas, ptr->filter_, ptr->cacheManager_, ptr->renderClearFilteredCacheAfterDrawing_, boundsRect);
    };
}
