...
std::unordered_map<MATERIAL_BLUR_STYLE, MaterialParam> materialParams_ { //RGBA
    // card blur params
    { STYLE_CARD_THIN_LIGHT,         { 23.0f,  1.05, 1.05, RSColor(0xFFFFFF33) } }, //春良Thin
    { STYLE_CARD_LIGHT,              { 57.0f,  1.2, 1.2, RSColor(0xFFFFFF33) } }, //春良Regular
    { STYLE_CARD_THICK_LIGHT,        { 57.0f,  1.2, 1.1, RSColor(0xFFFFFF8C) } }, //春良Thick
    ...
    { STYLE_BACKGROUND_MEDIUM_LIGHT, { 29.0f,  1.1,  1.0, RSColor(0x80808033) } }, // 春良Regular
    { STYLE_BACKGROUND_LARGE_LIGHT,  { 57.0f,  1.2,  1.0, RSColor(0x80808033) } }, //春良Thick
