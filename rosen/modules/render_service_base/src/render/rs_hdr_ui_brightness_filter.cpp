    ...
    const Drawing::Rect& src, const Drawing::Rect& dst) const
{
    ...
    float hdrUIBrightness = rscanvas.GetHDRBrightness() *
        (GetHDRUIBrightness() - DEFAULT_HDR_UI_BRIGHTNESS) + DEFAULT_HDR_UI_BRIGHTNESS;
    hdrUIBrightness = rscanvas.GetHdrOn() ? hdrUIBrightness : DEFAULT_HDR_UI_BRIGHTNESS;
