...
void RSRenderNode::FallbackAnimationsToRoot()
{
    ...
    auto context = GetContext().lock();
    if (!context) {
        ROSEN_LOGD("RSRenderNode::FallbackAnimationsToRoot: Invalid context");
        return;
    }
...
const std::shared_ptr<RSRenderNode> RSRenderNode::GetFirstLevelNode() const
{
    auto context = GetContext().lock();
    if (!context) {
        ROSEN_LOGD("RSRenderNode::GetFirstLevelNode: Invalid context");
        return nullptr;
    }
...
const std::shared_ptr<RSRenderNode> RSRenderNode::GetUifirstRootNode() const
{
    auto context = GetContext().lock();
    if (!context) {
        ROSEN_LOGD("RSRenderNode::GetUifirstRootNode: Invalid context");
        return nullptr;
    }
