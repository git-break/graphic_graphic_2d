...
enum HwcDisabledReasons {
    ...
    DISABLED_BY_ABOVED_BOUNDNEDSTRECT_HWCNODE = 16,
    DISABLED_BY_NO_BUFFER_IN_SKIPPEDBUFFER = 17,
    DISABLED_BY_CROSSNODE = 18,
    DISABLED_BY_SCREENNODE_ROTATION = 19,
    DISABLED_BY_ANCO_HAS_GPU = 20,
    DISABLED_BY_TOPLAYERS = 21,
    DISABLED_BY_ISCLONENODE = 22,
    DISABLED_BY_POINTWINDOW = 23,
    DISABLED_REASON_LENGTH = 24,
};
