...
public:
    ...
    // particle properties
    void SetParticles(std::vector<RSRenderParticle> particles);
    std::vector<RSRenderParticle> GetParticles() const;
...
#ifndef USE_ROSEN_DRAWING
    std::optional<std::vector<RSRenderParticle>> particles_;
